/**
 * not used in this final version deprecated opted for a different solution 'featured workshops' and "studios
 * @returns a list of classes / workshops hard coded json "
 */
export default    function Arteliers() {

    return (
        <div id="workshops" className="container py-5">
