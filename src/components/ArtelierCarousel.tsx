        ...
        caption: (
          <div className="floating_content">
            ...
            <div className="link_button_wrap">
              <a className="link_button" href="">Visit White</a>
            </div>
          </div>
        )
      },
      {
        ...
        caption: (
          <div className="floating_content">
            ...
            <div className="link_button_wrap">
              <a className="link_button" href="pages/static_gallery.html">Visit Make Believe</a>
            </div>
          </div>
        )
      },
      {
        ...
        caption: (
          <div className="floating_content">
            ...
            <div className="link_button_wrap">
              <a className="link_button" href="#artelier">Visit Apothecary</a>
            </div>
          </div>
        )
      }
